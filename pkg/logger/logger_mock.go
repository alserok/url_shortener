...
func (m *MockLogger) Debug(msg string, args ...Arg) {
	m.ctrl.T.Helper()
...
func (m *MockLogger) Error(msg string, args ...Arg) {
	m.ctrl.T.Helper()
	varargs := []interface{}{msg}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockLogger) Info(msg string, args ...Arg) {
	m.ctrl.T.Helper()
	varargs := []interface{}{msg}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (m *MockLogger) Warn(msg string, args ...Arg) {
	m.ctrl.T.Helper()
	varargs := []interface{}{msg}
	for _, a := range args {
		varargs = append(varargs, a)
